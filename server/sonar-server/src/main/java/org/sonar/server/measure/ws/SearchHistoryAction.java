...
public class SearchHistoryAction implements MeasuresWsAction {
  ...
  public void define(WebService.NewController context) {
    WebService.NewAction action = context.createAction("search_history")
  ...
  private List<SnapshotDto> searchAnalyses(DbSession dbSession, SearchHistoryRequest request, ComponentDto component) {
    ...
    setNullable(request.getFrom(), from -> dbQuery.setCreatedAfter(parseDateOrDateTime(request.getFrom()).getTime()));
    setNullable(request.getTo(), to -> dbQuery.setCreatedBefore(parseDateOrDateTime(request.getTo()).getTime()));
